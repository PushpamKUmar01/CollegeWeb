function getInputValue(){
    ...
    if(inputVal==1){
        document.getElementById("demo").innerHTML ="Pushpam kumar";
    ...
    {
        document.getElementById("demo").innerHTML ="Saurav kumar Saini";
        document.getElementById("demo1").innerHTML ="10000";   
    }

    else if(inputVal==4)
    {
        document.getElementById("demo").innerHTML ="Amanprit Singh";
        document.getElementById("demo1").innerHTML ="10000";   
    }
    else if(inputVal==5)
    {
        document.getElementById("demo").innerHTML ="Satyam Prakash";
        document.getElementById("demo1").innerHTML ="10000";   
    }
    else if(inputVal==6)
    {
